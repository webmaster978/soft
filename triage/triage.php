...
if (!isset($_SESSION['PROFILE']['id_utilisateur']) || $_SESSION['PROFILE']['designation'] != 'triage') {
            ...
            <div class="card">
                ...
                <div class="table-responsive datatable-custom position-relative">
                   ...
                   "pagination": "datatablePagination"
                        ...
                        <tbody>
                            <?php $requete = $db->query("SELECT * FROM fiches INNER JOIN patients ON fiches.ref_patient = patients.id_patient WHERE plaintes=''");
