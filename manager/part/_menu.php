<div class="leftside-menu">
                ...
                <!-- Brand Logo Light -->
                <a style="background-color: #FFFFFF;" href="dashboard" class="logo logo-light">
                    <span class="logo-lg">
                        <img style="width: 100px; height:60px;" src="../assets/images/logo/log.png" alt="logo clinovie">
                    </span>
                    <span class="logo-sm">
                        <img width="50px;" src="../assets/images/logo/log.png" alt="logo clinovie">
                    </span>
                </a>
                ...
                <a href="dashboard" class="logo logo-dark">
                    <span class="logo-lg">
                        <img src="../assets/images/logo/log.png" alt="dark logo">
                    </span>
                    <span class="logo-sm">
                        <img src="../assets/images/logo/log.png" alt="small logo">
                    </span>
                </a>
                ...
                <div class="h-100" id="leftside-menu-container" data-simplebar>
                    ...
                    <ul class="side-nav">
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarCrm">
                                <ul class="side-nav-second-level">
                                    <li>
                                        <a href="patients">Nos patients</a>
                                    </li>
                                    <li>
                                        <a href="#">Abonnees</a>
                                    </li>
                        ...
                        <li class="side-nav-title">Reception</li>
